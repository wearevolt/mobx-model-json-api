...
const testBody = {
  data: {
    ...
    relationships: {
      "betta-models": {
        data: [
          { type: "betta-models", id: 11 },
          { type: "betta-models", id: 12 },
        ]
      },
      "omega-model": {
        data: { type: "omega-models", id: 21 }
      }
    }
  },
  included: [
...
describe('Issue #10 Minus-separated attribute and model names not converted to CamelCase correctly', () => {
